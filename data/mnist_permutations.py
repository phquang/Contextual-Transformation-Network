...
parser.add_argument('--o', default='mnist30.pt', help='output file')
parser.add_argument('--n_tasks', default=30, type=int, help='number of tasks')
parser.add_argument('--seed', default=0, type=int, help='random seed')
parser.add_argument('--n_samples', default = 60000, type = int)
